        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 xs:gap-6 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-1 xs:space-y-2 text-gray-300 text-xs xs:text-sm sm:text-base">
              ...
              <li><button onClick={scrollToProducts} className="hover:text-yellow-400 transition-colors">Products</button></li>
          ...
          <div>
            ...
            <div className="space-y-1 xs:space-y-2 text-gray-300 text-xs xs:text-sm sm:text-base">
              <div className="flex items-center space-x-2">
                <Phone className="h-3 w-3 xs:h-4 xs:w-4 flex-shrink-0 text-orange-400" />
                <span>+91 6382737971 or +91 9943860510</span>
              </div>
              <div className="flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-2">
                <Home className="h-3 w-3 xs:h-4 xs:w-4 flex-shrink-0 text-purple-400" />
                <span>77Z/G,Gandhi Road,Sivakasi,Virudhunagar, TamilNadu - 626123</span>
              </div>
            </div>
          </div>
        </div>
